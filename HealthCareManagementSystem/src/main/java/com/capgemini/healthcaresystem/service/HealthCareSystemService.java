...
*                           adding,removing and displaying user and admin details. 
*                           Also to validate the user/admin for login and verify users
*                           to change the password and update password. 
*          Version          1.0
